//
// Author:      Mike Panter
// Website:     http://alchemise.net
// Disclaimer:  This software is provided by the author "as is" and any express or implied warranties are disclaimed.
//              in no event shall the author be liable for any loss arising from use of this code.
// Usage:       You are free to use and/or distribute this code for any purpose.
// Information: 
//
using System;
using System.Linq;
...
namespace UIDGenerator
{
    public class Encoder
    {
        ...
        protected const string MainWheel = "NPUV5KLM9AH7BWX6G8JYZ2RSD34CEFTQ";      
        protected const string InitialWheel = "QD32R7BFT9AMLG8HJYZUV5WX6NP4CESK";
        ...
        public static string Conceal(int value)
        {
            ...
            base32value = base32value.PadLeft(6, 'A'); // all results should have at least 5 chars
